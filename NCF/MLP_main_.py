...
def MLP_main_():
    ...
    dataset = MLP_Dataset(train, neg_data_per_pos_data=4)
    dataset_test = MLP_Dataset_test(test)
    ...
    model = MLP(train.shape[0], train.shape[1], config)
    ...
    for epoch in range(config.epochs):
        ...
        if best_test_loss > test_Loss_avg :
            ...
            torch.save(model.state_dict(), f'pretrained/pretrained_MLP.pth')
